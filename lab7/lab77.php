...
if(array_key_exists('enviar', $_POST)) { //array_key_exists — Verifica si el índice o clave dada existe en el array
...
<body>
    ...
    <br/>
    Introduzca el diametro en metros: <input type="text" name="altu" value="">
    <br/><br/>
